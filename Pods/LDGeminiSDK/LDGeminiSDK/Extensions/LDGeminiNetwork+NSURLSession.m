//
//  LDGeminiNetwork+NSURLSession.m
//  LDGeminiSDKiOS
//
...
#pragma mark - LDGeminiNetworkResponse
...
#pragma mark - LDGeminiNetwork

@implementation LDGeminiNetwork (NSURLSession)
...
+ (void)requestDataWithUrl:(NSString *)urlString
    ...
    if (!url) {
        NSError *error = [NSError errorWithDomain:@"LDGeminiSDK"
                                             code:22
